...
#include <esp_timer.h>
#include "flow_calc/flow_px4.hpp"
...
#define IMAGE_WIDTH 120 // FRAMESIZE_QQVGA,    // 160x120    FRAMESIZE_QQVGA2 => 128x160
#define IMAGE_HEIGHT 160 // FRAMESIZE_QQVGA,    // 160x120    FRAMESIZE_QQVGA2 => 128x160
...
void flow_setup(uint8_t *init_img) {
  ...
  opticalFlowPX4 = new OpticalFlowPX4(FOCAL_LENGTH, FOCAL_LENGTH, OUTPUT_RATE, IMAGE_WIDTH, IMAGE_WIDTH, 6, 30, 3000);
